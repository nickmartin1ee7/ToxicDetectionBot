...
public class ShowStatsUserCommand : IUserCommand
{
    private readonly ILogger<ShowStatsUserCommand> _logger;
    private readonly IServiceScopeFactory _serviceScopeFactory;

    public ShowStatsUserCommand(
        ILogger<ShowStatsUserCommand> logger,
    ...
    public async Task HandleAsync(SocketUserCommand command, DiscordSocketClient? client)
    {
